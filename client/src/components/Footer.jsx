...
export default function Footer() {
  return (
    <div className="w-full isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">{/* <CalendarDaysIcon aria-hidden="true" className="h-6 w-6 text-white" /> */}</div>
            ...
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">{/* <HandRaisedIcon aria-hidden="true" className="h-6 w-6 text-white" /> */}</div>
